 ...
 *
 * Intended use of this class is modifying the amount of any specific [items] entry (with no 64 upper limit), or [exp] amount, then accessing
 * the 64-parsed version of [items] through [splitDrops]
...
data class DeterminedDrop(
    ...
    val log = blockInstance.breaker.blockworks.logger.context("DeterminedDrop:${blockInstance.definition.material}")
